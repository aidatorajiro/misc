...
# an app id to copy compatdata from. please specify an app id of the proton-powered game that you own, after installing and running it once. also, please don't forget to run 'cat /proc/[pid of the game]/environ > dumpenvs'
SAMPLEAPPID=1720850
